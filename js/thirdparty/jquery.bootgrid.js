    ...
    */
    ...
    Grid.defaults = {
        ...
        templates: {
            ...
            search: "<div class=\"{{css.search}}\" style=\"margin-right:20px;\"><div class=\"input-group\"><span class=\"{{css.icon}} input-group-addon {{css.iconSearch}}\"></span> <input type=\"text\" class=\"{{css.searchField}}\" placeholder=\"{{lbl.search}}\" /></div></div>",
